...
- `scripts/check.sh` created a disposable PostgreSQL cluster, applied migrations 001 through 004, and loaded the seed twice. Integrity assertions, immutable acquisition records, foreign keys, and SQL examples passed.
